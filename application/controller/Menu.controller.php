...
class Menu extends Controller
{
    ...
    function index()
    {
        ...
        $this->di['js']->addJavascript(array("jquery-latest.min.js", "jquery-ui-1.10.3.custom.min.js", "jquery.mjs.nestedSortable.js", "menu.js", "bootstrap.min.js"));
...
/*
    ...
    <nav id="navbar-example" class="navbar navbar-inverse navbar-static navbar-fixed-top">
      <div class="container-fluid">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">PmaControl</a>
        </div>
