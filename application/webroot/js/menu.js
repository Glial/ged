jQuery(function($) {
    ...
    $('#easymm').nestedSortable({
        ...
        update: function() {
            ...
            $('#btn-save-menu').attr('disabled', false).children('span').removeClass("glyphicon-floppy-saved").addClass('glyphicon-floppy-disk');;
        }
    });
    ...
    $('#form-menu').submit(function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                //alert(data);
                $('#btn-save-menu').children("span").removeClass("glyphicon-floppy-disk").addClass('glyphicon-floppy-saved');
